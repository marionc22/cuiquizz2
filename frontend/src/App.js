...
function App() {
  ...
  let [a, setA] = React.useState(Math.floor(Math.random() * 30));
  let [b, setB] = React.useState(Math.floor(Math.random() * 30));
  let [c, setC] = React.useState(Math.floor(Math.random() * 30));
  ...
  function play2(event) {
    ...
    if (x === 3) {
      ...
      setA(Math.floor(Math.random() * 30));
    ...
    if (x === 4) {
      ...
      setB(Math.floor(Math.random() * 30));
      setCurrentPlayer(`${player1Name} à ton tour`);
      setRun(true);
      setX(2);
    }
  ...
  function play3(event) {
    ...
    if (x === 6) {
      ...
      setC(Math.floor(Math.random() * 30));
      setCurrentPlayer(`${player1Name} à ton tour`);
      setRun(true);
      setX(3);
    }
